...
export const DropContent = styled.div`
  ...
  box-shadow: 0 0 0 1px ${themeVal('color.alpha')},
    0 0 32px 2px ${themeVal('color.alpha')},
...
export const DropMenu = styled.ul`
  ...
  margin: ${glsp(-1, -1, 1, -1)};
  box-shadow:
    0 ${themeVal('layout.border')} 0 0 ${themeVal('color.mist')};
  padding: ${glsp(1 / 2, 0)};
  min-width: 12rem;
...
export const DropInset = styled.div`
  ...
  box-shadow: inset 0 ${themeVal('layout.border')} 0 0
      ${themeVal('color.mist')},
    inset 0 -${themeVal('layout.border')} 0 0 ${themeVal('color.mist')};
  margin: ${glsp(-1, -1, 1, -1)};
  padding: ${glsp()};

  &:first-child {
    box-shadow: inset 0 -${themeVal('layout.border')} 0 0 ${themeVal('color.mist')};
  }
